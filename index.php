...
// Viết chương trình PHP để kiểm tra xem một chuỗi có chứa một từ cụ thể hay không.
    echo "<hr>";
    function kiemTraC($chuoi, $tuCanTim) {
        ...
        $chuoi = "Chuỗi này là chuỗi ngẫu nhiên";
        $tuCanTim = "chuỗi";    
        kiemTraC($chuoi, $tuCanTim);
        echo "<hr>";
